...
public class VistaProductosEliminar extends JFrame implements IGUI{
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(aux.equals("") || aux == null) Utils.showErrorMsg(ENTRADA_INCORRECTA);
					...
					Controlador.getInstancia().accion(EventosControlador.PRODUCTOS_ELIMINAR, id);
					setVisible(false);
				}
			}
		});
	...
	public void actualizar(int evento, Object datos) {
		int id = (int) datos;
		setVisible(false);
		if(evento == EventosControlador.PRODUCTOS_ELIMINAR_OK) Utils.showOkMsg("Se ha eliminado correctamente el producto con id " + id);
		else if(evento == EventosControlador.PRODUCTOS_ELIMINAR_ERROR) Utils.showErrorMsg("No se ha podido eliminar el producto con id" + id);
	}
