...
public class VistaEventosBuscar extends JFrame implements IGUI {
	...
	private void initGUI() {
		...
		JLabel titulo = new JLabel("Buscar evento");
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstancia().accion(EventosControlador.EVENTOS_BUSCAR, id);
				setVisible(false);
			}
		});
	...
	public void actualizar(int evento, Object datos) {
		setVisible(false);
		if(evento == EventosControlador.EVENTOS_BUSCAR_OK) {
			TEvento transfer = (TEvento) datos;
			StringBuilder datosEvento = new StringBuilder("Se ha encontrado el siguiente evento con id " + transfer.getId());
			datosEvento.append("\nNombre: " + transfer.getNombre());
			datosEvento.append("\nTipo: " + String.valueOf(transfer.getTipo()));
			datosEvento.append("\nAforo: " + transfer.getAforo());
			datosEvento.append("\nEstado: ");
			if(transfer.getActivo()) datosEvento.append("Activo");
			else datosEvento.append("No Activo");
			Utils.showOkMsg(datosEvento.toString());
		}
		else Utils.showErrorMsg("No se ha encontrado ningun evento con el id introducido");
		Controlador.getInstancia().accion(EventosControlador.EVENTOS_VISTA_INICIO, null);
	}
